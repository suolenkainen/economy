...
class Workorder_tests(unittest.TestCase):
    ...
    def test_combine_two_workorders(self,):
        ...
        attr_dict2 = {'id': 1, 'owner': 1, 'destination': -1, 'sell': False, 'product': 'grain', 'method': '', 'worker': -1, 'reserved': -1, 'price': 11.5, 'amount': 5, 'capacityperitem': 0, 'distance': 0, 'angle': -1, 'processed': 'free'}
        attr_dict3 = {'id': 2, 'owner': 1, 'destination': -1, 'sell': True, 'product': 'bread', 'method': '', 'worker': -1, 'reserved': -1, 'price': 10.0, 'amount': 4, 'capacityperitem': 2, 'distance': 0, 'angle': -1, 'processed': 'free'}
        attr_dict4 = {'id': 3, 'owner': 0, 'destination': -1, 'sell': False, 'product': 'bread', 'method': '', 'worker': -1, 'reserved': -1, 'price': 9.9, 'amount': 4, 'capacityperitem': 0, 'distance': 0, 'angle': -1, 'processed': 'free'}
