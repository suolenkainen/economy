...
class producer_tests(unittest.TestCase):

    # Testing producer creation
    @patch('src.producers.fetch_conf_data')
    def test_create_producer(self, mock_fetch):
        ...
        result = producers.create_producers_from_configures()
    ...
    @patch('src.producers.fetch_conf_data')
    def test_create_multiple_producer(self, mock_fetch):
